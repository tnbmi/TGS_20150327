//*****************************************************************************
//
// CMeshDomeクラス [meshDome.h]
// Author :MAI TANABE
//
//*****************************************************************************

#ifndef _MY_MESH_DOME_H
#define _MY_MESH_DOME_H
//=============================================================================
...
{
public:
	CMeshDome(int priority = 0, OBJTYPE objType = OBJTYPE_DOME);
	~CMeshDome(){};

	static CMeshDome* Create(LPDIRECT3DDEVICE9 device, CImport::TEXTURES texture, D3DXVECTOR3 sizeBlock, D3DXVECTOR3 numBlock);
	...
	void		SetSize(float radius){m_size = D3DXVECTOR3(radius, radius, radius); SetVertexPolygon();}
